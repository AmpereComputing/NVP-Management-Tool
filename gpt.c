 ...
 *          1 - Failure
 **/
int get_gpt_disk_info (int dev_fd, int show_gpt)
{
    ...
    memcpy(&gpt_hd, lba_buff, sizeof(struct gpt_header));
 ...
 *          1 - Failure
 **/
int get_gpt_part_guid_info(uint8_t *guid, uint32_t *offset, uint32_t *size)
{
 ...
 *          1 - Failure
 **/
int get_gpt_part_name_info(char *part, uint32_t *offset, uint32_t *size)
{
    int i = 0, ret = EXIT_SUCCESS;
